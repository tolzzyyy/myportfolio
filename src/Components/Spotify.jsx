...
const refresh_token =
  "AQD5WSUkUwTXtw3GhqWE_9XiVV_EZ35MJd-wwiY-bL7bJ9MalXSct6CBbxN9uPO3sK-8q3PX6qHpbeZpQ1meEssMibvWzLtsLA8A7lpfewsk-2MMdOadanOgl0CXEzrsKEw";
  ...
  return (
    ...
    >
      ...
      <div className="flex ml-[6px] gap-[5px] items-center">
        ...
        <div id="nowPlayingDetails" className=" flex text-left flex-col py-2   ">
          <div
            className={`nowPlayingTitle text-[8px] font-bold leading-tight overflow-hidden ${
              title.length > 25 ? "marquee-container" : "truncate"
            }`}
          >
            {playerState === "PLAY" || playerState === "PAUSE" ? (
              <a
                className="text-black pt-2 hover:text-blue-500"
          ...
          <div className="nowPlayingArtist text-[6px]   text-gray-600">
            {playerState === "PLAY" || playerState === "PAUSE" ? (
              <a
                className="text-gray-600 pb-2 hover:text-blue-500"
